          ...
          choices: [
            {
              id: "a",
              label: "A",
              text: "Yes, it preserves relative order of equal elements",
            },
            {
              id: "b",
              label: "B",
...
const treeNodes_ord1: Node[] = [
  {
    id: "n10",
    type: "custom",
    data: { label: "10", variant: "circle" },
    position: { x: 200, y: 30 },
  },
  {
    id: "n5",
    type: "custom",
    data: { label: "5", variant: "circle" },
    position: { x: 100, y: 130 },
  },
  {
    id: "n15",
    type: "custom",
    data: { label: "15", variant: "circle" },
    position: { x: 300, y: 130 },
  },
  {
    id: "n3",
    type: "custom",
    data: { label: "3", variant: "circle" },
    position: { x: 30, y: 230 },
  },
  {
    id: "n7",
    type: "custom",
    data: { label: "7", variant: "circle" },
          ...
          choices: [
            {
              id: "a",
              label: "A",
              text: "A sorted sequence in ascending order",
            },
            {
              id: "b",
              label: "B",
              text: "A sorted sequence in descending order",
            },
...
const graphNodes_ord1: Node[] = [
  {
    id: "nA",
    type: "custom",
    data: { label: "A", variant: "circle" },
    position: { x: 30, y: 160 },
  },
  {
    id: "nB",
    type: "custom",
    data: { label: "B", variant: "circle" },
    position: { x: 180, y: 30 },
  },
  {
    id: "nC",
    type: "custom",
    data: { label: "C", variant: "circle" },
    position: { x: 350, y: 30 },
  },
  {
    id: "nD",
    type: "custom",
    data: { label: "D", variant: "circle" },
    position: { x: 180, y: 280 },
  },
  {
    id: "nE",
    type: "custom",
    data: { label: "E", variant: "circle" },
...
const graphNodes_ord2: Node[] = [
  {
    id: "nX",
    type: "custom",
    data: { label: "X", variant: "circle" },
    position: { x: 30, y: 130 },
  },
  {
    id: "nY",
    type: "custom",
    data: { label: "Y", variant: "circle" },
    position: { x: 200, y: 30 },
  },
  {
    id: "nZ",
    type: "custom",
    data: { label: "Z", variant: "circle" },
    position: { x: 200, y: 240 },
  },
  {
    id: "nW",
    type: "custom",
    data: { label: "W", variant: "circle" },
