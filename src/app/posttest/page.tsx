...
function hasAnswer(answer: PosttestUserAnswer): boolean {
    switch (answer.type) {
        case "multiple_choice":
            return answer.selectedChoiceId !== null && answer.selectedChoiceId !== undefined;
        case "fill_blank":
...
export default function PosttestPage() {
    return (
        <Suspense fallback={<div className="bg-white min-h-screen w-full flex items-center justify-center"><p className="text-lg text-gray-500">Loading...</p></div>}>
            <PosttestContent />
        </Suspense>
    );
}
