 ...
 */
export function removeAVLWithAnimation(
  root: AVLTreeNode | null,
  value: number,
  recorder?: AnimationRecorder,
): AVLTreeNode | null {
 ...
 */
function removeBSTOnly(
  root: AVLTreeNode | null,
  value: number,
): { root: AVLTreeNode | null; successorId: string | null } {
 ...
 */
export function deserializeAVLTree(
  data: SerializedAVLNode | null,
): AVLTreeNode | null {
 ...
 */
export function getTreeNodesArray(
  root: AVLTreeNode | null,
  result: AVLTreeNode[] = [],
): AVLTreeNode[] {
