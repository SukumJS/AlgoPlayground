...
export default function CodeGenerateSearch({
  title = "Code",
  code = "",
  language = "python",
  tutorialMode = false,
  ...
  const defaultCode: string = `ALGORITHM GenerateSearchSteps(algoType, nodes, target)
    RESET all nodes to idle
    IF algoType == "binary-search" THEN
        RETURN BinarySearchSteps(nodes, target)
    ELSE
        RETURN LinearSearchSteps(nodes, target)
    END IF
END ALGORITHM`;
