...
interface TutorialGraphProps {
    ...
    nodeSpotlightRadius?: number;
    weightSpotlightRadius?: number;
    // Weight input
...
export default function TutorialGraph({
    ...
    trashBinPos,
    isTrashActive = false,
    nodeSpotlightRadius = 45,
    weightSpotlightRadius = 30,
                ...
                <defs>
                    <mask id="graph-spotlight-mask">
                        ...
                        {currentStep === 0 && node69ScreenPos && (
                            <circle cx={node69ScreenPos.x} cy={node69ScreenPos.y} r={nodeSpotlightRadius} fill="black" />
                        )}
