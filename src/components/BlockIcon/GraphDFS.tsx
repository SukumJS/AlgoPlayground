    ...
    <div className={`relative w-24 h-24 ${className}`}>
      ...
      >
        <line
          ...
          x2="-25"
          y2="10"
          className="stroke-white group-hover:stroke-blue-300 transition-colors duration-300 delay-500"
        />
        <line
          x1="10"
          y1="-50"
        ...
        <line
          ...
          x2="80"
          y2="40"
          className="stroke-white group-hover:stroke-blue-300 transition-colors duration-300 delay-600"
        />
        <line
          x1="90"
          y1="-10"
